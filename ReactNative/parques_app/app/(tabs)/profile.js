    ...
    <LinearGradient className="absolute w-full h-full" colors={['#5A3F37', '#2C7744']}>
      <SafeAreaView className="h-full " edges={['top']}>
        <View className="w-full h-[60%] items-center py-2 relative">
          <LinearGradient className="absolute w-full h-[90%] rounded-3xl" colors={['#CCCCB2', '#757519']} />
          ...
          <View className="w-full h-[50%] items-center justify-around ">
            ...
            <View className="items-center">
              ...
              <View className="">
                <Text className="text-black">monica@gmail.com</Text>
              </View>
            </View>
          </View>

          <View className="w-[90%] h-[15%] flex-row items-center bg-primary rounded-t-xl mt-7 ">
            <View className="w-1/2 h-full flex-row items-center justify-center ">
              <FontAwesomeIcon icon={faGem} color='#93c5fd' size={32} />
              <Text className="ml-2 text-[#925131] font-bold">120 puntos</Text>
            </View>
            <View className="w-1/2 h-full flex-row items-center justify-center ">
              <FontAwesomeIcon icon={faTree} color='#22c55e' size={32} />
              <Text className="ml-2 text-[#925131] font-bold">Visitados: 3</Text>
            </View>
          </View>
          <View className="w-[90%] h-[15%] flex-row items-center bg-primary rounded-b-xl ">
            <View className="w-1/2 h-full flex-row items-center justify-center">
              <CountryFlag isoCode="de" size={25} />
              <Text className="ml-2 text-[#925131] font-bold">Alemania</Text>
            </View>
            <View className="w-1/2 h-full flex-row items-center justify-center ">
              <FontAwesomeIcon icon={faCommentAlt} color='black' size={32} />
              <Text className="ml-2 text-[#925131] font-bold">Reseñas: 3</Text>
            </View>
          </View>
        ...
        <View className="w-full h-[40%]">
          <View className="w-full h-[20%] justify-end">
            <Text className="font-semibold text-lg ml-2 text-white ">Tus reseñas</Text>
          </View>
