    ...
    <div style={{ width: '75%', height: '90%', backgroundColor: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', borderRadius:20 }}>
      ...
      <form style={{ width: '80%', height: '20%',  display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <div style={{ width: '100%' }}>
          ...
          <input style={{ width: '90%', height: 40, margin: 0, paddingInline: 8, outline: 'none', marginTop: 8,background:'#EFEFEF',border:'none',borderRadius:10 }} placeholder={'Launch rocket to the moon'} />
        </div>
        <button style={{ width: 100, height: 40, marginTop: 13, background:'#71357C', color:'white', border:'none', borderRadius:10 }}>Create Task</button>
      </form>
